...
bcrypt = Bcrypt(app)
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///database.db' #connects our DB to app file.
...
class RegisterForm(FlaskForm):
    ...
    def vslidate_username(self, username):
        existing_user_username = User.query.filterby(username=username.data).first()
        if existing_user_username:
            raise ValidationError('That user name alredy exist. Choose an another one!')
